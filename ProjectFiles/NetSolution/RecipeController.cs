...
public class RecipeController : BaseNetLogic
{
    ...
    public void ExportAndIterateFilePath()
    {
        ...
        var originalCsvPath = GetCSVFilePath();
    ...
    [ExportMethod]
    public void RecipeExistsInStorePush(string recipeName)
    {

        RecipeSchema schema = GetRecipeSchema();

        var store = GetStoreObject(schema);
        ...
        var testResult = Owner.GetVariable("RecipeNameAlreadyExists");
        testResult.Value = rowCount > 0;
    }
